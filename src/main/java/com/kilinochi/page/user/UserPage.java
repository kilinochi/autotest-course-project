...
public final class UserPage extends BasePage {
    ...
    private static final By PRODUCT_LOCATOR = By.xpath("//*[@hrefattrs=\"st.cmd=mall&st.ePT=cn%3Amenu&st._aid=NavMenu_User_Mall\"]");
    private static final By HOLIDAY_LOCATOR = By.xpath("//*[@hrefattrs=\"st.cmd=eventsCalendar&st._aid=NavMenu_User_EventsCalendar\"]");
    ...
    public ProductMainPage productMainPage() {
        click(PRODUCT_LOCATOR);
        return new ProductMainPage();
    }

    public HolidayPage holidayPage() {
        click(MORE_LOCATOR);
        click(HOLIDAY_LOCATOR);
    ...
    protected void check() {
        ...
        explicitWaitVisible(PRODUCT_LOCATOR);
